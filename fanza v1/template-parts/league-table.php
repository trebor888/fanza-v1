...
endforeach;
$output .= '<th class="data-rank">' . __( 'Form' ) . '</th>';
...
foreach ( $data as $team_id => $row ):
    ...
    $output .= '<td class="col-form data-' . $key . $td_class . '" data-label="'.$labels[$key].'">';
    foreach ($events as $event) {
        ...
        $sdfsdf =  get_post_meta($event_id, 'sp_results', true);
        //print_r($sdfsdf);
        
        
	        foreach($sdfsdf as $key => $sdfsd) {
	        	if($key == $team_id){
		        	if ('win' === $sdfsd['outcome']) {
		               $output .= '<span class="result-win">W</span>';
		            } elseif ('loss' == $sdfsd['outcome']) {
		               $output .= '<span class="result-loss">L</span>';
		            } elseif ('draw' == $sdfsd['outcome']) {
		               $output .= '<span class="result-draw">D</span>';
		            } else {
		               $output .= '<span class="result-what">?</span>';
		            }
		        }
	        }
